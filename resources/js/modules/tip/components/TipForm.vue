<template>
    <section id="tip-form">
        <el-form
            ...
            <el-form-item label="Tip Name" prop="name" :error="errors.get('name')">
                <el-input
                    v-model="form.name"
    ...
    export default {
        ...
        data() {
            return {
                ...
                rules: {
                    name: [
                        {required: true, message: 'tip name is required'},
                    ],
                },
            }
        },
            ...
            saveSubmit() {
                this.$refs['form'].validate((valid) => {
                    if (valid) {
                        ...
                        this.errors.clear()
                        let action = this.form.id ? tipApi.update : tipApi.create
