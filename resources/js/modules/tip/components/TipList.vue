<template>
    <section id="tip">
        ...
        <el-table
            ...
            <el-table-column prop="name" label="Name" min-width="200" sortable>
                <template slot-scope="scope">
                    <router-link class="el-link el-link--default ellipsis-form" :to="{name: 'Show Tip', params: {id: scope.row.id}}">
        ...
        <el-dialog
            ...
            class="tips-dialog">
            <TipForm :initialForm="formData" @saved="saved" @cancel="formVisible = false" />
        </el-dialog>
    </section>
</template>
...
<script>
    ...
    import {TIP_FETCH, TIP_OBTAIN} from "../store/types";
    ...
    export default {
        ...
        computed: {
            ...mapGetters(['tips', 'tipsMeta', 'tipsLoading']),
        },
        created() {
            this.fetchData()
        },
        ...
        methods: {
            ...mapActions([TIP_FETCH]),
            ...mapMutations([TIP_OBTAIN]),
            ...
            fetchData() {
                ...
                this[TIP_FETCH](params)
            },
            handleAdd() {
                this.formTitle = 'New Tip';
                this.formData = {};
                this.formVisible = true;
            },
            handleEdit(row) {
                this.formTitle = 'Edit Tip';
                this.formData = Object.assign({}, row);
                this.formVisible = true;
            },
            handleDelete(row) {
                this.$confirm('This will permanently delete the tip. Continue?', 'Warning', {
                    type: 'warning'
                }).then(() => {
                    tipApi.delete(row.id).then((response) => {
                        this.$message({
