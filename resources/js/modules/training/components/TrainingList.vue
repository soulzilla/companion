<template>
    <section id="training">
        ...
        <el-table
            ...
            <el-table-column prop="name" label="Name" min-width="200" sortable>
                <template slot-scope="scope">
                    <router-link class="el-link el-link--default ellipsis-form" :to="{name: 'Show Training', params: {id: scope.row.id}}">
        ...
        <el-dialog
            ...
            class="trainings-dialog">
            <TrainingForm :initialForm="formData" @saved="saved" @cancel="formVisible = false" />
        </el-dialog>
    </section>
</template>
...
<script>
    ...
    import {TRAINING_FETCH, TRAINING_OBTAIN} from "../store/types";
    ...
    export default {
        ...
        computed: {
            ...mapGetters(['trainings', 'trainingsMeta', 'trainingsLoading']),
        },
        created() {
            this.fetchData()
        },
        ...
        methods: {
            ...mapActions([TRAINING_FETCH]),
            ...mapMutations([TRAINING_OBTAIN]),
            ...
            fetchData() {
                ...
                this[TRAINING_FETCH](params)
            },
            handleAdd() {
                this.formTitle = 'New Training';
                this.formData = {};
            ...
            handleDelete(row) {
                this.$confirm('This will permanently delete the training. Continue?', 'Warning', {
                    type: 'warning'
                }).then(() => {
                    trainingApi.delete(row.id).then((response) => {
                        this.$message({
