<template>
    <section id="advertisement">
        ...
        <el-table
            ...
            v-loading="advertisementsLoading"
            ...
            <el-table-column prop="name" label="Name" min-width="200" sortable>
                <template slot-scope="scope">
                    <router-link class="el-link el-link--default ellipsis-form" :to="{name: 'Show Advertisement', params: {id: scope.row.id}}">
        ...
        <el-pagination
            ...
            :total="advertisementsMeta.total"
        ...
        <el-dialog
            ...
            class="advertisements-dialog">
            <AdvertisementForm :initialForm="formData" @saved="saved" @cancel="formVisible = false" />
        </el-dialog>
    </section>
</template>
...
<script>
    ...
    import {ADVERTISEMENT_FETCH, ADVERTISEMENT_OBTAIN} from "../store/types";
    ...
    export default {
        ...
        computed: {
            ...mapGetters(['advertisements', 'advertisementsMeta', 'advertisementsLoading']),
        },
        created() {
            this.fetchData()
        },
        ...
        methods: {
            ...mapActions([ADVERTISEMENT_FETCH]),
            ...mapMutations([ADVERTISEMENT_OBTAIN]),
            ...
            fetchData() {
                ...
                this[ADVERTISEMENT_FETCH](params)
            },
            handleAdd() {
                this.formTitle = 'New Advertisement';
                this.formData = {};
                this.formVisible = true;
            },
            handleEdit(row) {
                this.formTitle = 'Edit Advertisement';
            ...
            handleDelete(row) {
                this.$confirm('This will permanently delete the advertisement. Continue?', 'Warning', {
                    ...
                    advertisementApi.delete(row.id).then((response) => {
                        this.$message({
