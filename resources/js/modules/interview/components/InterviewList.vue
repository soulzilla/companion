<template>
    <section id="interview">
        ...
        <el-table
            ...
            <el-table-column prop="name" label="Name" min-width="200" sortable>
                <template slot-scope="scope">
                    <router-link class="el-link el-link--default ellipsis-form" :to="{name: 'Show Interview', params: {id: scope.row.id}}">
        ...
        <el-dialog
            ...
            class="interviews-dialog">
            <InterviewForm :initialForm="formData" @saved="saved" @cancel="formVisible = false" />
        </el-dialog>
    </section>
</template>
...
<script>
    ...
    import {INTERVIEW_FETCH, INTERVIEW_OBTAIN} from "../store/types";
    ...
    export default {
        ...
        computed: {
            ...mapGetters(['interviews', 'interviewsMeta', 'interviewsLoading']),
        },
        created() {
            this.fetchData()
        },
        ...
        methods: {
            ...mapActions([INTERVIEW_FETCH]),
            ...mapMutations([INTERVIEW_OBTAIN]),
            ...
            fetchData() {
                ...
                this[INTERVIEW_FETCH](params)
            },
            handleAdd() {
                this.formTitle = 'New Interview';
                this.formData = {};
            ...
            handleDelete(row) {
                this.$confirm('This will permanently delete the interview. Continue?', 'Warning', {
                    type: 'warning'
                }).then(() => {
                    interviewApi.delete(row.id).then((response) => {
                        this.$message({
