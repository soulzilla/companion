<template>
    <section id="map">
        ...
        <el-table
            ...
            <el-table-column prop="name" label="Name" min-width="200" sortable>
                <template slot-scope="scope">
                    <router-link class="el-link el-link--default ellipsis-form" :to="{name: 'Show Map', params: {id: scope.row.id}}">
        ...
        <el-dialog
            ...
            class="maps-dialog">
            <MapForm :initialForm="formData" @saved="saved" @cancel="formVisible = false" />
        </el-dialog>
    </section>
</template>
...
<script>
    ...
    import {MAP_FETCH, MAP_OBTAIN} from "../store/types";
    ...
    export default {
        ...
        computed: {
            ...mapGetters(['maps', 'mapsMeta', 'mapsLoading']),
        },
        created() {
            this.fetchData()
        },
        ...
        methods: {
            ...mapActions([MAP_FETCH]),
            ...mapMutations([MAP_OBTAIN]),
            ...
            fetchData() {
                ...
                this[MAP_FETCH](params)
            },
            handleAdd() {
                this.formTitle = 'New Map';
                this.formData = {};
                this.formVisible = true;
            },
            handleEdit(row) {
                this.formTitle = 'Edit Map';
                this.formData = Object.assign({}, row);
                this.formVisible = true;
            },
            handleDelete(row) {
                this.$confirm('This will permanently delete the map. Continue?', 'Warning', {
                    type: 'warning'
                }).then(() => {
                    mapApi.delete(row.id).then((response) => {
                        this.$message({
