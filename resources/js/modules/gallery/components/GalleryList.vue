<template>
    <section id="gallery">
        ...
        <el-table
            ...
            <el-table-column prop="name" label="Name" min-width="200" sortable>
                <template slot-scope="scope">
                    <router-link class="el-link el-link--default ellipsis-form" :to="{name: 'Show Gallery', params: {id: scope.row.id}}">
        ...
        <el-dialog
            ...
            class="galleries-dialog">
            <GalleryForm :initialForm="formData" @saved="saved" @cancel="formVisible = false" />
        </el-dialog>
    </section>
</template>
...
<script>
    ...
    import {GALLERY_FETCH, GALLERY_OBTAIN} from "../store/types";
    ...
    export default {
        ...
        data: () => ({
            ...
            page: 1,
            formVisible: false,
            formTitle: 'New Gallery',
            formData: null
        }),
        computed: {
            ...mapGetters(['galleries', 'galleriesMeta', 'galleriesLoading']),
        },
        created() {
            this.fetchData()
        },
        ...
        methods: {
            ...mapActions([GALLERY_FETCH]),
            ...mapMutations([GALLERY_OBTAIN]),
            ...
            fetchData() {
                ...
                this[GALLERY_FETCH](params)
            },
            handleAdd() {
                this.formTitle = 'New Gallery';
                this.formData = {};
                this.formVisible = true;
            },
            handleEdit(row) {
                this.formTitle = 'Edit Gallery';
                this.formData = Object.assign({}, row);
                this.formVisible = true;
            },
            handleDelete(row) {
                this.$confirm('This will permanently delete the gallery. Continue?', 'Warning', {
                    type: 'warning'
                }).then(() => {
                    galleryApi.delete(row.id).then((response) => {
                        this.$message({
