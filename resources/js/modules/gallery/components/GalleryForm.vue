<template>
    <section id="gallery-form">
        <el-form
            ...
            <el-form-item label="Gallery url" prop="url" :error="errors.get('url')">
                <el-input
                    v-model="form.url"
    ...
    export default {
        ...
        data() {
            return {
                ...
                rules: {
                    url: [
                        {required: true, message: 'gallery url is required'},
                    ],
                    published: []
                },
            }
            ...
            saveSubmit() {
                this.$refs['form'].validate((valid) => {
                    if (valid) {
                        ...
                        this.errors.clear()
                        let action = this.form.id ? galleryApi.update : galleryApi.create
