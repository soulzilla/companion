<template>
    <section id="advantage">
        ...
        <el-table
            ...
            <el-table-column prop="name" label="Name" min-width="200" sortable>
                <template slot-scope="scope">
                    <router-link class="el-link el-link--default ellipsis-form" :to="{name: 'Show Advantage', params: {id: scope.row.id}}">
        ...
        <el-dialog
            ...
            class="advantages-dialog">
            <AdvantageForm :initialForm="formData" @saved="saved" @cancel="formVisible = false" />
        </el-dialog>
    </section>
</template>
...
<script>
    ...
    import {ADVANTAGE_FETCH, ADVANTAGE_OBTAIN} from "../store/types";
    ...
    export default {
        ...
        computed: {
            ...mapGetters(['advantages', 'advantagesMeta', 'advantagesLoading']),
        },
        created() {
            this.fetchData()
        },
        ...
        methods: {
            ...mapActions([ADVANTAGE_FETCH]),
            ...mapMutations([ADVANTAGE_OBTAIN]),
            ...
            fetchData() {
                ...
                this[ADVANTAGE_FETCH](params)
            },
            handleAdd() {
                this.formTitle = 'New Advantage';
                this.formData = {};
                this.formVisible = true;
            },
            handleEdit(row) {
                this.formTitle = 'Edit Advantage';
                this.formData = Object.assign({}, row);
                this.formVisible = true;
            },
            handleDelete(row) {
                this.$confirm('This will permanently delete the advantage. Continue?', 'Warning', {
                    type: 'warning'
                }).then(() => {
                    advantageApi.delete(row.id).then((response) => {
                        this.$message({
