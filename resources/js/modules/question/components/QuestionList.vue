<template>
    <section id="question">
        ...
        <el-table
            ...
            <el-table-column prop="name" label="Name" min-width="200" sortable>
                <template slot-scope="scope">
                    <router-link class="el-link el-link--default ellipsis-form" :to="{name: 'Show Question', params: {id: scope.row.id}}">
        ...
        <el-dialog
            ...
            <QuestionForm :initialForm="formData" @saved="saved" @cancel="formVisible = false" />
        </el-dialog>
    </section>
</template>
...
<script>
    ...
    import {QUESTION_FETCH, QUESTION_OBTAIN} from "../store/types";
    ...
    export default {
        ...
        computed: {
            ...mapGetters(['questions', 'questionsMeta', 'questionsLoading']),
        },
        created() {
            this.fetchData()
        },
        ...
        methods: {
            ...mapActions([QUESTION_FETCH]),
            ...mapMutations([QUESTION_OBTAIN]),
            ...
            fetchData() {
                ...
                this[QUESTION_FETCH](params)
            },
            handleAdd() {
                this.formTitle = 'New Question';
                this.formData = {};
            ...
            handleDelete(row) {
                this.$confirm('This will permanently delete the question. Continue?', 'Warning', {
                    ...
                    questionApi.delete(row.id).then((response) => {
                        this.$message({
